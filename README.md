...
If you plan to implement custom models and dataset for your new applications, we provide a dataset [template](data/skfold_dataset.py) and a model [template](models/template_model.py) as a starting point.
